...
const Navbar = () => {
  ...
  return (
    <nav className="">
      ...
      <div onClick={() => toggleMenu()} className={`flex flex-col flex-1 h-screen  transition-all  duration-300 ease-in-out overflow-hidden relative top-0 z-10 lg:hidden ${isOpen ? 'max-h-screen' : 'max-h-0'}`}>
        <div className={`bg-activebrown   backdrop-opacity-5  `}>
          <ul className="flex-col  text-white gap-10 ">
            ...
            <li className="px-4 py-2 ">
              <p className="p-2 rounded-md bg-bg2 text-primary">Pages</p>
            </li>
            <li className="px-4 py-2 ">
              <p className="p-2 rounded-md bg-bg2 text-primary">About</p>
            </li>
            <li className="px-4 py-2 ">
              <p className="p-2 rounded-md bg-bg2 text-primary">Blog</p>
            </li>
            <li className="px-4 py-2 ">
              <p className="p-2 rounded-md bg-bg2 text-primary">Contact</p>
            </li>
            <li className="px-4 py-2 ">
              <p className="p-2 rounded-md bg-bg2 text-primary">Service</p>
            </li>
          </ul>
